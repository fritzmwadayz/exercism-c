...
def fix_list_of_wagons(each_wagons_id, missing_wagons):
    ...
    """
    [a,b, *all] = each_wagons_id
    [c, *d] = all
    new = [c]+missing_wagons+d+[a,b]
...
def add_missing_stops(route, **kwargs):
    ...
    routes = [value for key, value in kwargs.items()]

    unpacked_info = {"stops":routes}
    
    routes_with_stops = {**route, **unpacked_info}
