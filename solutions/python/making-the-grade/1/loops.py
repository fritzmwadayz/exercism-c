...
def letter_grades(highest):
    ...
    grade_list = [41, 41+grade_range, 41+grade_range*2, 41+grade_range*3]
...
def student_ranking(student_scores, student_names):
    ...
    """
    sorted_entries = []
    for posn, (score, name) in enumerate(zip(student_scores, student_names), start=1):
        entry = f'{posn}. {name}: {score}'
